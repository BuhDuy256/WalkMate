...
public class CreateIntentViewModel extends ViewModel {
    ...
    public void submit(String hotspotId, float timeStart, float timeEnd, int ageMin, int ageMax) {
        ...
        intentRepository.createIntent(hotspotId, timeStart, timeEnd, ageMin, ageMax,
                new DomainCallback<WalkIntent>() {
                    ...
                    public void onError(Exception error) {
                        uiState.postValue(new CreateIntentUiState(false, error.getMessage(), null));
                    }
                });
    }

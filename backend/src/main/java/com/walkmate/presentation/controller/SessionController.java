...
public class SessionController {
    ...
    public ApiResponse<SessionResponse> activate(
            @PathVariable UUID id,
            @AuthenticationPrincipal Jwt jwt,
            @RequestHeader(value = "X-User-Id", required = false) String userIdHeader) {
        WalkSession session = activateService.execute(UserIdentityExtractor.extractUserId(jwt, userIdHeader), id);
    ...
    public ApiResponse<SessionResponse> cancel(
        ...
        WalkSession session = cancelService.execute(UserIdentityExtractor.extractUserId(jwt, userIdHeader), id,
                request.reason());
        return ApiResponse.success(mapper.toResponse(session));
    }
    ...
    public ApiResponse<SessionResponse> complete(
        ...
        WalkSession session = completeService.execute(UserIdentityExtractor.extractUserId(jwt, userIdHeader),
                id,
    ...
    public ApiResponse<SessionResponse> abort(
        ...
        WalkSession session = abortService.execute(UserIdentityExtractor.extractUserId(jwt, userIdHeader), id,
                request.reason());
        return ApiResponse.success(mapper.toResponse(session));
    }

...
public final class TrustScorePolicy {
    ...
    /**
     * Returns the trust-score delta for a submitted incident report reason (Stage 3).
     *
     * <p>Penalties are one-directional (negative or zero). The result is intended to
